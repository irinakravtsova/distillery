    ...
    <div className='advertising-box'>
          ...
          <ul className="box-wrapper">
           ...
           <li className='box-title box-subtitle'>
            (так говорят все, кому посчастливилось  пробовать мой божественный бренди) 
           </li>
           <li className='box-text'>
           Если вы действитльно готовы сделать своими руками элитный фруктовый бренди, который удивит игрой нот и богатым вкусом, вам необходимо учесть кое-какие нюансы.
           </li>
           <li className='box-text'>
           Подробно о том:
           </li>
           ...
           Обо всем этом и много другом, очень важном, читайте в моем авторском курсе 
           </li>
           <li className='box-text subtext '>
           "Фруктовый самогон. Вкусно, просто и недорого" 
           </li>
           <li className='box-text subtext '>
           и на ТГ канале "Моя домашняя винокурня"
           </li>
           <li className='box-title box-subtitle'>
